...
public class PerPribadi7 extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detailperlengkapan);
        String judul="SARUNG TANGAN DAN KAOS KAKI PENGGANTI";
        String pribadi="Sarung tangan dan kaos kaki sangat dibutuhkan pendaki di gunung"+
                "\n\nSarung tangan dan kaos kaki dapat meminimalisir dingin."+
                "\nUpayakan bedakan kaos kaki untuk tidur dan yang dipakai untuk perjalanan.";
