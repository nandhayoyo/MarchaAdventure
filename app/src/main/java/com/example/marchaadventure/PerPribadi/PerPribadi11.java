...
public class PerPribadi11 extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detailperlengkapan);
        String judul="Obat-obatan dan P3K";
        String pribadi="Obat-obatan di gunung tak melulu dipakai bila selama perjalanan tubuh dalam keadaan fit"+
                "\n\nTapi alangkah baiknya membawa obat-obatan sebagai langkah antisipasi bila kondisi tubuh tiba-tiba ngedrop maupun terluka.";
