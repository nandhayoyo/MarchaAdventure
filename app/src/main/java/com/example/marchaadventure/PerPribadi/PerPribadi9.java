...
public class PerPribadi9 extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detailperlengkapan);
        String judul="TISU KERING / BASAH";
        String pribadi="Tisu kering maupun basar berguna selama pendakian."+
                "\n\nTisu dapat dipakai untuk membersihkan diri usai buang air dan dapat membersihkan peralatan makan.";
